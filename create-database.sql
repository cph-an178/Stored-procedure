...
create database stackexchange DEFAULT CHARACTER SET utf8 DEFAULT COLLATE utf8_general_ci;
...
load xml infile '/var/lib/mysql-files/coffee/Badges.xml'
into table badges
rows identified by '<row>';

load xml infile '/var/lib/mysql-files/coffee/Comments.xml'
into table comments
rows identified by '<row>';

load xml infile '/var/lib/mysql-files/coffee/PostHistory.xml'
into table post_history
rows identified by '<row>';

load xml infile '/var/lib/mysql-files/coffee/PostLinks.xml'
into table post_links
rows identified BY '<row>';

load xml infile '/var/lib/mysql-files/coffee/Posts.xml'
into table posts
rows identified by '<row>';

load xml infile '/var/lib/mysql-files/coffee/Tags.xml'
into table tags
rows identified BY '<row>';

load xml infile '/var/lib/mysql-files/coffee/Users.xml'
into table users
rows identified by '<row>';

load xml infile '/var/lib/mysql-files/coffee/Votes.xml'
into table votes
rows identified by '<row>';
